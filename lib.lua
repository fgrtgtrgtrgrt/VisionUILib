...
function library:CreateWindow(name, version, icon)
	...
	Icon.ImageColor3 = Color3.fromRGB(200, 100, 255)
	...
	TitleUnderline.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
	...
	function tabs:CreateTab(name)
		...
		Indicator.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
		...
		function mytabbuttons:CreateFrame(name)
			...
			SearchIcon.ImageColor3 = Color3.fromRGB(200, 100, 255)

			Bar_3.Name = "Bar"
			Bar_3.Parent = SearchBar
			Bar_3.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				spawn(function()
					local function QCZV_fake_script() -- Caller.Handler 
						...
						Sample.ImageColor3 = Color3.fromRGB(200, 100, 255)
			...
			function pagebuttons:CreateLabel(name)
				...
				Label.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
				...
				_4pxShadow2px.ImageColor3 = Color3.fromRGB(200, 100, 255)
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Indicator_3.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
				...
				Shadow_1.ImageColor3 = Color3.fromRGB(200, 100, 255)
				...
				TextButton_2.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
				...
				Shadow_2.ImageColor3 = Color3.fromRGB(200, 100, 255)
				...
				Fade.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				Footer_3.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
				...
				EditIcon.ImageColor3 = Color3.fromRGB(200, 100, 255)
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Footer_2.BackgroundColor3 = Color3.fromRGB(200, 100, 255)
